<template>
    <div class="per-page flex gap-4 items-center px-5">
        <p class="text-base m-0 text-18">Entries per page: </p>

        <div class="wrapper relative">
            <div class="selected-option w-[67px] h-[48px] bg-white rounded-[8px] flex justify-center items-center text-base text-18 cursor-pointer" @click="toggle">{{perPage ?? 10}}</div>
            <div
            ...
            >
                <div class="option bg-white py-3 px-5" :class="{active: perPage == 10}" @click="setPerPage(10)">10</div>
