<template>
    <div :class="$attrs.class">
        <label v-if="label" class="form-label block mb-3 text-16 text-[#5D5D60] font-bold " :class="this.$attrs.labelClass" :for="id">{{label}}</label>
        ...
        <div v-if="(error && typeof error == 'string')" class="text-[#FF0000] text-12 mt-2" :class="$attrs.errorClass">{{ error }}</div>
    </div>
</template>
